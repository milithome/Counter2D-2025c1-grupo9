...
std::vector<uint8_t> Protocol::serialize_create_join_leave(const Response& r) {
...
void Protocol::send_response(const Response& r) {
    ...
    switch (r.type) {
        ...
        case Type::JOIN:
        case Type::LEAVE:
            buffer = serialize_create_join_leave(r);
            break;
...
Response Protocol::deserialize_simple_response(Type type) {
    Response r;
    r.type = type;
...
Response Protocol::recv_response() {
    ...
    switch (type) {
        ...
        case Type::JOIN:
        case Type::LEAVE:
            return deserialize_simple_response(type);
        case Type::LIST:
