...
MenuClient::MenuClient(QApplication& app, MenuController& menuController, Queue<Response> &recv_queue, Queue<std::shared_ptr<MessageEvent>> &send_queue, Protocol &protocol) :
...
bool MenuClient::run(bool looped) {
    ...
    QObject::connect(timer, &QTimer::timeout, timer, [this, timer]() {
        Response msg;
        try {
